...
import { ReqSendMessage, ResSendMessage, ResChatHistory, ResChatLogs } from '../types/chat';
...
export const getChatLogs = async (): Promise<ResChatLogs> => {
  const res = await instance.get('/chat/logs');
